/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+cpp+java+javadoclike+kotlin+markup-templating+php+phpdoc+php-extras+plsql+python+rust+sass+scss+sql&plugins=line-numbers */
...
Prism = function (e) {
    ...
    a = {
            ...
            clone: function e(n, t) {
                ...
                switch (t = t || {
                    ...
                    case 'Object':
                        ...
                        for (var l in r = {
                        }, t[i] = r, n) n.hasOwnProperty(l) && (r[l] = e(n[l], t));
                        return r;
                    case 'Array':
                        return i = a.util.objId(n),
                        t[i] ? t[i] : (r = [
                        ], t[i] = r, n.forEach((function (n, a) {
                            r[a] = e(n, t)
                        })), r);
                    default:
                        return n
        ...
        highlightElement: function (n, t, r) {
            ...
            if (a.hooks.run('before-sanity-check', s), (o = s.element.parentElement) && 'pre' === o.nodeName.toLowerCase() && !o.hasAttribute('tabindex') && o.setAttribute('tabindex', '0'), !s.code) return a.hooks.run('complete', s),
        ...
        tokenize: function (e, n) {
            ...
            function (e) {
                for (var n = [
                ], t = e.head.next; t !== e.tail; ) n.push(t.value),
                t = t.next;
                return n
            }(a)
        },
