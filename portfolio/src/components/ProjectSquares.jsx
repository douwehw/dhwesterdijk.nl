		...
		return (
			<>
				...
				<div className='w-full grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mb-12 gap-2'>
					...
					/>
					<ProjectSquare
						href='https://github.com/48exa/raylib-bubbleshooter'
						name='RayLib Bubbleshooter & Tycoon'
						description='Eerste game project in C++ met RayLib, een Bubbleshooter en een Tycoon game.'
						language='C++'
						rating='8.7'
						hours='32'
					/>
				...
				<div className='w-full grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mb-12 gap-2'>
					...
					<ProjectSquare
						...
						name='Global Game Jam Award Winning Game'
						description='Project van de GGJ in Groningen 2024, winner van de "Curveball" Award'
						language='C#'
						rating='10'
						hours='16'
					/>
			...
			<>
				...
				<div className='w-full grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mb-12 gap-2'>
					...
					<ProjectSquare
						href='https://github.com/48exa/raylib-bubbleshooter'
						name='RayLib Bubbleshooter & Tycoon'
						description='First game project in C++ with RayLib, a Bubbleshooter and a Tycoon game.'
						language='C++'
						rating='8.7'
						hours='32'
					/>
				...
				<div className='w-full grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mb-12 gap-2'>
					...
					<ProjectSquare
						href='https://github.com/Buldz/Tweakin_Gamejam2024'
						name='Global Game Jam Award Winning Game'
						description='Project from the GGJ in Groningen 2024, winner of the "Curveball" Award.'
						language='C#'
						rating='10'
						hours='16'
					/>
